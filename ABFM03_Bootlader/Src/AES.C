...
const unsigned char AES_KEY[32] = "Accompany_Amiro_Stm32g030_Aeskey";
...
/输出： 0加密成功，1失败
***************************************************************************/
unsigned char AES_ENCODE(unsigned char *key,unsigned char *databuf,unsigned int datalen)//数据长度要为16的倍数,密钥为32位
{
...
/输出： 0解密成功，1失败
***************************************************************************/
unsigned char AES_DECODE(unsigned char *key,unsigned char *databuf,unsigned int datalen)//数据长度要为16的倍数,密钥为32位
{
  unsigned char chainCipherBlock[16];
  unsigned long *CLR=(unsigned long *)chainCipherBlock;
  unsigned int i,k;	
