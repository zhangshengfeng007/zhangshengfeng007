...
#include "Handle.h"
////LED 档位灯模式灯  测试
#define GEAR_LED1_PIN       GPIO_PIN_15 ///档位LED1
#define GEAR_LED1_PORT		GPIOB
#define GEAR_LED2_PIN       GPIO_PIN_2 ///档位LED2
#define GEAR_LED2_PORT		GPIOB
#define GEAR_LED3_PIN       GPIO_PIN_6 ///档位LED3
#define GEAR_LED3_PORT		GPIOC
#define GEAR_LED4_PIN       GPIO_PIN_7 ///档位LED4
#define GEAR_LED4_PORT		GPIOC
#define GEAR_LED5_PIN       GPIO_PIN_11 ///档位LED5
#define GEAR_LED5_PORT		GPIOA


#define RF_LED_PIN          GPIO_PIN_14 ///RF模式LED
#define RF_LED_PORT			GPIOB
#define EMS_LED_PIN         GPIO_PIN_2 ///EMS模式LED
