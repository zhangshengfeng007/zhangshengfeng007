...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, BACKLIGHT_EN_Pin|USB_BUS_SW_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RF_OUT_SW_Pin|EMS_OUT_SW_Pin|SYS_BUS_SW_Pin|C_SENSOR_LED_Pin
                          |CHARGE_ILMIT_Pin, GPIO_PIN_RESET);
