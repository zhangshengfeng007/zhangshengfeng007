...
/**
  ...
  */
#define ADC_EOSMP_EVENT          (Read_ADC_Flag_EOSMP) /*!< ADC End of Sampling event */
#define ADC_AWD1_EVENT           (Read_ADC_Flag_AWD1)  /*!< ADC Analog watchdog 1 event (main analog watchdog)       */
#define ADC_AWD2_EVENT           (Read_ADC_Flag_AWD2)  /*!< ADC Analog watchdog 2 event (additional analog watchdog) */
#define ADC_AWD3_EVENT           (Read_ADC_Flag_AWD3)  /*!< ADC Analog watchdog 3 event (additional analog watchdog) */
#define ADC_OVR_EVENT            (Read_ADC_Flag_OVR)   /*!< ADC overrun event */
/**
  * @}
  */
...
/** @defgroup Read_ADC_Flags_definition ADC flags definition
  * @{
  */
#define Read_ADC_Flag_RDY           ADC_ISR_ADRDY    /*!< ADC Ready flag */
#define Read_ADC_Flag_CCRDY         ADC_ISR_CCRDY    /*!< ADC channel configuration ready flag */
#define Read_ADC_Flag_EOSMP         ADC_ISR_EOSMP    /*!< ADC End of Sampling flag */
#define Read_ADC_Flag_EOC           ADC_ISR_EOC      /*!< ADC End of Regular Conversion flag */
#define Read_ADC_Flag_EOS           ADC_ISR_EOS      /*!< ADC End of Regular sequence of Conversions flag */
#define Read_ADC_Flag_OVR           ADC_ISR_OVR      /*!< ADC overrun flag */
#define Read_ADC_Flag_AWD1          ADC_ISR_AWD1     /*!< ADC Analog watchdog 1 flag */
#define Read_ADC_Flag_AWD2          ADC_ISR_AWD2     /*!< ADC Analog watchdog 2 flag */
#define Read_ADC_Flag_AWD3          ADC_ISR_AWD3     /*!< ADC Analog watchdog 3 flag */
/**
  * @}
  */
...
#define Read_ADC_Flag_POSTCONV_ALL    (Read_ADC_Flag_AWD | Read_ADC_Flag_OVR | Read_ADC_Flag_EOS | Read_ADC_Flag_EOC)
...
/**
  ...
  *        This parameter can be one of the following values:
  *            @arg @ref Read_ADC_Flag_RDY    ADC Ready flag
  *            @arg @ref Read_ADC_Flag_CCRDY  ADC channel configuration ready flag
  *            @arg @ref Read_ADC_Flag_EOSMP   ADC End of Sampling flag
  *            @arg @ref Read_ADC_Flag_EOC     ADC End of Regular Conversion flag
  *            @arg @ref Read_ADC_Flag_EOS     ADC End of Regular sequence of Conversions flag
  *            @arg @ref Read_ADC_Flag_OVR     ADC overrun flag
  *            @arg @ref Read_ADC_Flag_AWD1    ADC Analog watchdog 1 flag (main analog watchdog)
  *            @arg @ref Read_ADC_Flag_AWD2    ADC Analog watchdog 2 flag (additional analog watchdog)
  *            @arg @ref Read_ADC_Flag_AWD3    ADC Analog watchdog 3 flag (additional analog watchdog)
