...
/** @defgroup ADC_LL_EC_FLAG ADC flags
  ...
  * @{
  */
#define LL_Read_ADC_Flag_ADRDY                  ADC_ISR_ADRDY      /*!< ADC flag ADC instance ready */
#define LL_Read_ADC_Flag_CCRDY                  ADC_ISR_CCRDY      /*!< ADC flag ADC channel configuration ready */
#define LL_Read_ADC_Flag_EOC                    ADC_ISR_EOC        /*!< ADC flag ADC group regular end of unitary
                                                                   conversion */
#define LL_Read_ADC_Flag_EOS                    ADC_ISR_EOS        /*!< ADC flag ADC group regular end of sequence
                                                                   conversions */
#define LL_Read_ADC_Flag_OVR                    ADC_ISR_OVR        /*!< ADC flag ADC group regular overrun */
#define LL_Read_ADC_Flag_EOSMP                  ADC_ISR_EOSMP      /*!< ADC flag ADC group regular end of sampling phase */
#define LL_Read_ADC_Flag_AWD1                   ADC_ISR_AWD1       /*!< ADC flag ADC analog watchdog 1 */
#define LL_Read_ADC_Flag_AWD2                   ADC_ISR_AWD2       /*!< ADC flag ADC analog watchdog 2 */
#define LL_Read_ADC_Flag_AWD3                   ADC_ISR_AWD3       /*!< ADC flag ADC analog watchdog 3 */
#define LL_Read_ADC_Flag_EOCAL                  ADC_ISR_EOCAL      /*!< ADC flag end of calibration */
/**
  * @}
  */
...
/**
  ...
  *         ADC conversion start.
  *         Refer to device datasheet, parameter tSTAB.
  * @note   On this STM32 series, flag LL_Read_ADC_Flag_ADRDY is raised when the ADC
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_ADRDY) == (LL_Read_ADC_Flag_ADRDY)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_CCRDY) == (LL_Read_ADC_Flag_CCRDY)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_EOS) == (LL_Read_ADC_Flag_EOS)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_OVR) == (LL_Read_ADC_Flag_OVR)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_EOSMP) == (LL_Read_ADC_Flag_EOSMP)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_AWD1) == (LL_Read_ADC_Flag_AWD1)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_AWD2) == (LL_Read_ADC_Flag_AWD2)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_AWD3) == (LL_Read_ADC_Flag_AWD3)) ? 1UL : 0UL);
}
...
{
  return ((READ_BIT(ADCx->ISR, LL_Read_ADC_Flag_EOCAL) == (LL_Read_ADC_Flag_EOCAL)) ? 1UL : 0UL);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_ADRDY);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_CCRDY);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_EOC);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_EOS);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_OVR);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_EOSMP);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_AWD1);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_AWD2);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_AWD3);
}
...
{
  WRITE_REG(ADCx->ISR, LL_Read_ADC_Flag_EOCAL);
}
...
{
  SET_BIT(ADCx->IER, LL_Read_ADC_Flag_CCRDY);
}
...
{
  CLEAR_BIT(ADCx->IER, LL_Read_ADC_Flag_CCRDY);
}
...
{
  return ((READ_BIT(ADCx->IER, LL_Read_ADC_Flag_CCRDY) == (LL_Read_ADC_Flag_CCRDY)) ? 1UL : 0UL);
}
