...
ErrorStatus LL_ADC_DeInit(ADC_TypeDef *ADCx)
{
      ...
      == 0UL)
  {
    ...
    /* Reset register ISR */
    SET_BIT(ADCx->ISR,
            (LL_Read_ADC_Flag_ADRDY
             | LL_Read_ADC_Flag_EOC
             | LL_Read_ADC_Flag_EOS
             | LL_Read_ADC_Flag_OVR
             | LL_Read_ADC_Flag_EOSMP
             | LL_Read_ADC_Flag_AWD1
             | LL_Read_ADC_Flag_AWD2
             | LL_Read_ADC_Flag_AWD3
             | LL_Read_ADC_Flag_EOCAL
             | LL_Read_ADC_Flag_CCRDY
            )
           );
